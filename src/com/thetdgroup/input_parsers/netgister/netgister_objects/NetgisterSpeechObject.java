...
public final class NetgisterSpeechObject
{
 ...
 //
 private TreeMap<Integer, NetgisterSpeechTokenObject> tokenMap = new TreeMap<Integer, NetgisterSpeechTokenObject>();
 ...
 //
 public void addToken(final String tokenID, final NetgisterSpeechTokenObject token)
 {
 ...
 public String getSpeechFragment()
 {
  ...
  for(Map.Entry<Integer, NetgisterSpeechTokenObject> entry : this.tokenMap.entrySet())
  {
 ...
 public String getAnnotatedSpeechFragment()
 {
  StringBuffer stringBuffer = new StringBuffer();
	 ...
	 for(Map.Entry<Integer, NetgisterSpeechTokenObject> entry : this.tokenMap.entrySet())
	 {
	 	NetgisterSpeechTokenObject bbnTokenObject = this.tokenMap.get(entry.getKey());
